...
- You can run an integration Terratest test from examples subfolder, for any other tests, create a single main.tf and various tfvars files inside tests subfolder.
